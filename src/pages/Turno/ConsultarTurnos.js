...
function ConsultarTurnos(props) {
            ...
            <Card style={{ width: '100%' }}>
              <Card.Body>
                ...
                <Row>
                    ...
                    <Col>
                        <Button href="/turno" variant="outline-dark" block>Crear</Button>
                    </Col>
                    <Col>
                ...
                <div className="ag-theme-alpine" style={{ height: 300 }}>
                    <AgGridReact
                        ...
                        <AgGridColumn cellRenderer="gridCellButton" cellRendererParams={{ path: 'turno', text: 'Editar' }}></AgGridColumn>
                    </AgGridReact>
                </div>
              </Card.Body>
            </Card>
